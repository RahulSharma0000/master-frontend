      ...
      <div className="space-y-3">
        ...
        {filtered.map((c) => (
          ...
          >
            ...
            <div className="text-gray-600">{c.relationship}</div>
            ...
            <div className="flex justify-end gap-2 col-span-2 md:col-span-1">
              <IconButton color="gray" onClick={() => navigate(`/controls/co-applicant/view/${c.id}`)}>
                <FiEye />
              </IconButton>
              <IconButton color="blue" onClick={() => navigate(`/controls/co-applicant/edit/${c.id}`)}>
                <FiEdit3 />
              </IconButton>
